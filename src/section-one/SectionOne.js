...
export default class SectionOne extends Component {
  ...
  offerCountDownHandler({ days, hours, minutes, seconds, completed }) {
    if (completed) {
      return (
        <>
                <div className="position-absolute top-0 start-0 d-flex justify-content-center align-items-center w-100 h-100 bg-dark bg-opacity-50">
          <h1 className="fw-semi-bold">Offer has ended:(</h1>
        </div>
        ...
        <div className="section-one-offer-parent rounded-4 position-relative">
          ...
          >
            {this.state.productOnSales.map((item) => {
              return (
                <SwiperSlide className="section-one-offer-items-parent w-100 bg-white rounded-3 position-relative">
